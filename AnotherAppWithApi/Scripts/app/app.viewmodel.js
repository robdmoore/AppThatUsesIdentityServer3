        ...
        self[options.bindingMemberName] = ko.computed(function () {
            if (!dataModel.getAccessToken()) {
                ...
                if (fragment.access_token) {
                    ...
                    window.location = "http://appwithformsauth.localtest.me/api/oauth/authorize?client_id=web&response_type=token&state=" + encodeURIComponent(window.location.hash);
                }
            }
